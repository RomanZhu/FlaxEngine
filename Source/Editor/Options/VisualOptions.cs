...
namespace FlaxEditor.Options
{
    ...
    public sealed class VisualOptions
    {
        ...
        [EditorDisplay("Editor Console", "Info Color"), EditorOrder(1500), Tooltip("The color used for editor console info messages.")]
        ...
        [EditorDisplay("Editor Console", "Warning Color"), EditorOrder(1501), Tooltip("The color used for editor console warnings.")]
        ...
        [EditorDisplay("Editor Console", "Error Color"), EditorOrder(1502), Tooltip("The color used for editor console errors.")]
        public Color LogErrorColor { get; set; } = Color.Red;

        /// <summary>
        /// Legacy setting for coloring debug log entries.
        /// </summary>
        [DefaultValue(true)]
        [HideInEditor]
