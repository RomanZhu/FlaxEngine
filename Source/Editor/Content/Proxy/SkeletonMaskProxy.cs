...
namespace FlaxEditor.Content
{
    ...
    public class SkeletonMaskProxy : BinaryAssetProxy
    {
        ...
        /// <inheritdoc />
        public override string FileExtension => CanonicalGraphDocuments.UseTextGraphAssets ? "skeletonmask" : Extension;
        ...
        public override bool AcceptsAsset(string typeName, string path)
        {
            ...
            return string.Equals(extension, ".flax", StringComparison.OrdinalIgnoreCase) ||
                   string.Equals(extension, ".skeletonmask", StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            CanonicalGraphDocuments.EnsureCanAuthor(typeof(SkeletonMask).FullName, outputPath);
