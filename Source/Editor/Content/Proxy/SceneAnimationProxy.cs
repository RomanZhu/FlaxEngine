...
namespace FlaxEditor.Content
{
    ...
    public class SceneAnimationProxy : BinaryAssetProxy
    {
        ...
        public override bool AcceptsAsset(string typeName, string path)
        {
            ...
            return string.Equals(extension, ".sceneanimation", StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            if (AuthoredAssetDocumentService.Create(outputPath, typeof(SceneAnimation).FullName) == Guid.Empty)
