...
namespace FlaxEditor.Content
{
    ...
    public class AnimationGraphProxy : BinaryAssetProxy
    {
        ...
        /// <inheritdoc />
        public override string FileExtension => "animgraph";
        ...
        public override bool AcceptsAsset(string typeName, string path)
        {
            ...
            return string.Equals(extension, ".animgraph", StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            if (AssetDocumentRegistry.CreateGraph(outputPath, typeof(AnimationGraph).FullName) == Guid.Empty)
