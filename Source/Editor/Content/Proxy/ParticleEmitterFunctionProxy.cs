...
namespace FlaxEditor.Content
{
    ...
    public class ParticleEmitterFunctionProxy : BinaryAssetProxy
    {
        ...
        /// <inheritdoc />
        public override string FileExtension => "particlefunction";
        ...
        public override bool AcceptsAsset(string typeName, string path)
        {
            ...
            return string.Equals(extension, ".particlefunction", StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            if (AssetDocumentRegistry.CreateGraph(outputPath, typeof(ParticleEmitterFunction).FullName) == Guid.Empty)
