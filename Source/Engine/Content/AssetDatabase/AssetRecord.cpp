...
bool AssetRecord::HasSameIdentityAndContent(const AssetRecord& other) const
{
    return ID == other.ID && SourceAssetID == other.SourceAssetID && LocalId == other.LocalId && TypeName == other.TypeName &&
        ...
        BuildInputObjectDependencies == other.BuildInputObjectDependencies && BuildInputDependencies == other.BuildInputDependencies &&
        RuntimeObjectReferences == other.RuntimeObjectReferences && RuntimeReferences == other.RuntimeReferences;
}
