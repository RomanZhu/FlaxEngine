...
namespace FlaxEngine.Tests
{
    ...
    public class TestCliCommandStartup
    {
        ...
        {
            Assert.IsFalse(CliRequestService.IsCommandStartupReady(true, false, true));
            Assert.IsFalse(CliRequestService.IsCommandStartupReady(false, true, true));
            Assert.IsFalse(CliRequestService.IsCommandStartupReady(true, true, false));
            Assert.IsTrue(CliRequestService.IsCommandStartupReady(true, true, true));
