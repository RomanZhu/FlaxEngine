...
Texture2D<uint> ProbeStates : register(t__SRV__);
...
{
	float3 irradiance = SampleDDGIIrradiance(DDGI, ProbesData, ProbeStates, ProbesDistance, ProbesIrradiance, gBuffer.WorldPos, gBuffer.Normal);
